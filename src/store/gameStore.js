...
class GameStore {
    ...
    toggleMute() {
        ...
        this.setSoundMuteState();
    }

    setSoundMuteState() {
      if (this.gameSound) {
        this.gameSound.muted = this.isMuted;  // Mute or unmute the sound
      }
    }
    ...
    async checkSuccessOrFall() {
        ...
        if (
            ...
            this.targetDistance =
                this.futurePlatform.position - this.playerPosition;
    ...
    generateFuturePlatform() {
        ...
        const futurePosition =
            this.playerPosition +
            this.targetDistance +
            Math.max(Math.random() * 150 + 50, 400);
