                ...
                <div className="modal">
                    <div className="modal__content">
                        ...
                        <div className="modal__social">
                            ...
                            <a href="https://www.instagram.com/mono.software/" className="modal__anchor"><svg version="1.1" viewBox="0 0 512 512" width={20} height={20} xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://x.com/monosoftware" className="modal__anchor"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" viewBox="0 0 24 24"><path fill="#000000" fillRule="evenodd" d="M22.905 0.304a1 1 0 0 1 0.05 1.414l-8.136 8.725 8.98 11.92A1 1 0 0 1 23 23.964h-5.478a1 1 0 0 1 -0.799 -0.398l-6.32 -8.387 -7.894 8.467a1 1 0 1 1 -1.463 -1.364l8.136 -8.725 -8.98 -11.92A1 1 0 0 1 1 0.036h5.479a1 1 0 0 1 0.798 0.398l6.32 8.387L21.49 0.354a1 1 0 0 1 1.414 -0.05Zm-10.15 10.724a0.998 0.998 0 0 1 -0.078 -0.103L5.98 2.035H3.005l15.015 19.93h2.975l-8.24 -10.937Z" clipRule="evenodd" strokeWidth="1"></path></svg> @mono.software</a>
